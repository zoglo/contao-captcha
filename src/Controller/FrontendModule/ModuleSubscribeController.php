 ...
 */
class ModuleSubscribeController extends Module
{
	/**
	 * Template
	 * @var string
	...
	public function generate()
	{
		...
		if ($request && System::getContainer()->get('contao.routing.scope_matcher')->isBackendRequest($request))
		{
            ...
            $objTemplate->wildcard = '### ' . mb_strtoupper($GLOBALS['TL_LANG']['FMD']['subscribe'][0], 'UTF-8') . ' ###';
...
class_alias(ModuleSubscribeController::class, 'ModuleSubscribe');
