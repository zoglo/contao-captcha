...
namespace Zoglo\ContaoCaptcha\Controller\FrontendModule;
 ...
 */
class ModuleUnsubscribeController extends Module
{
	/**
	 * Template
	 * @var string
	...
	public function generate()
	{
		...
		if ($request && System::getContainer()->get('contao.routing.scope_matcher')->isBackendRequest($request))
		{
			...
			$objTemplate->wildcard = '### ' . mb_strtoupper($GLOBALS['TL_LANG']['FMD']['unsubscribe'][0], 'UTF-8') . ' ###';
...
class_alias(ModuleUnsubscribeController::class, 'ModuleUnsubscribe');
